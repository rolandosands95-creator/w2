...
<body>
    ...
    <script>
        ...
        function myFunction() {
            if (confirm("Your Apple ID was recently used at CHILD PORNOGRAPHY WEBSITE for $549.59 Via Apple Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Apple Support +1-888-493-6059 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
